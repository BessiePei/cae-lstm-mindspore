...
where:
`--case` indicates the case to run. You can choose 'sod', 'shu_osher', ann', 'kh' or 'cylinder'. Default 'sod'，where 'sod' and 'shu_osher' are one dimension cases, 'riemann', 'kh' and 'cylinder' are two dimension cases
